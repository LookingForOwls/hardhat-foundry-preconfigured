...
export async function deployCounter(wallet: Wallet, gasOpts?: GasOptions, initCount?: number): Promise<Counter> {
...
async function isZkDeployment(wallet: Wallet): Promise<boolean> {
  ...
  return ZK_EVM && (net.chainId === chainIds[`zksync-mainnet`] || net.chainId === chainIds[`zksync-goerli`]);
}
